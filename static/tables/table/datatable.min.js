...
(function (f) {
    ...
    function Ga(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && d && "No hay datos en la tabla" === b.sEmptyTable && M(a, a, "sZeroRecords", "sEmptyTable");
            !a.sLoadingRecords && d && "Cargando..." === b.sLoadingRecords && M(a, a,
    ...
    q.defaults = {
        ...
        oLanguage: {
            ...
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "No se han encontrado datos relacionados con la búsqueda"
        },
